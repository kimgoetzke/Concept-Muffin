        ...
        public struct PlayerActions
        {
            ...
            public void SetCallbacks(IPlayerActions instance)
            {
                if (m_Wrapper.m_PlayerActionsCallbackInterface != null)
                {
                    ...
                    @EquipmentSlot1.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot1;
                    @EquipmentSlot1.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot1;
                    @EquipmentSlot1.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot1;
                    @EquipmentSlot2.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot2;
                    @EquipmentSlot2.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot2;
                    @EquipmentSlot2.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot2;
                    @EquipmentSlot3.started -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot3;
                    @EquipmentSlot3.performed -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot3;
                    @EquipmentSlot3.canceled -= m_Wrapper.m_PlayerActionsCallbackInterface.OnEquipmentSlot3;
